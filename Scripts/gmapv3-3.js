...
function getClusterOption() {
    if (clusterOptions == null) {
        clusterOptions = { gridSize: 40, maxZoom: 11, imagePath: rootPath + 'Modules/Globalcaching/media/m' };
    }
...
function markerFilterChanged() {
    ...
    markerClusterer = new MarkerClusterer(map, visibleMarkers, getClusterOption());
}
...
function initializeMap(centerLat, centerLon, zoom, rPath, gcFilter, getgcUrl, getwpUrl, canDl) {
    rootPath = rPath;
    filter = gcFilter;
